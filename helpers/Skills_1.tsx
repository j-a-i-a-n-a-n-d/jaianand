...
function Skills_1({ props }: Props) {
  ...
  return (
    ...
    >
      <img
        src={props.image_id}
        className='cursor-pointer flex-shrink-0 text-2xl w-16 h-16 md:w-[78px] md:h-[78px] 2xl:w-24 2xl:h-24 object-contain rounded-full'
      />
      {isHovered && (
        <div className='absolute top-0 left-0 w-16 h-16 md:w-20 md:h-20 2xl:w-24 2xl:h-24'>
          <div
